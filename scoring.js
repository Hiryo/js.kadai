$(document).ready(function() {
  function score_indicate(sum_indicate) {
  ...
  function get_achievement(average_indicate) {
    let subject_points = [Number($('#national_language').val()),
      Number($('#english').val()),
      Number($('#mathematics').val()),
      Number($('#science').val()),
  ...
  function get_pass_or_failure(judgement) {
    let subject_points = [Number($('#national_language').val()),
      Number($('#english').val()),
      Number($('#mathematics').val()),
      Number($('#science').val()),
  ...
  function judgement() {
    ...
    let achievement = get_achievement(average_indicate);
    // 変数「pass_or_failure」に「get_pass_or_failure()の戻り値」を代入します。
    let pass_or_failure = get_pass_or_failure(judgement);
